...
function BubbleText:new(text, text_size, radius, outer_color, center_color)
    -- Create table to be returned, as class instance with setmetatable
    local t = {}
    ...
    -- Create a target canvas to draw to.
    ...
    -- Set love canvas to the one we created, cleared with alpha.
    love.graphics.setCanvas(t._image)
    love.graphics.clear(0, 0, 0, 0)
    love.graphics.setBlendMode("alpha")

    -- Set the canvas render color to outer_color
    ...
    -- reset canvas and color to default.
